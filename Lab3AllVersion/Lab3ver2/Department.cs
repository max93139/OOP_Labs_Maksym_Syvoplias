...
namespace Lab3
{
    ...
    public class Department
    {
        ...
        public List<string> Disciplines
        {
            ...
            set
            {
                disciplines = new List<string>(value);
            }
        }
        ...
        /// <param name="student">Об'єкт студента, якого потрібно додати.</param>
        ...
        /// <param name="number">Порядковий номер студента.</param>
        ...
        /// <param name="number">Порядковий номер студента.</param>
        /// <returns>Знайдений студент або null.</returns>
        ...
        /// <param name="discipline">Назва дисципліни.</param>
        ...
        /// <param name="discipline">Назва дисципліни для видалення.</param>
