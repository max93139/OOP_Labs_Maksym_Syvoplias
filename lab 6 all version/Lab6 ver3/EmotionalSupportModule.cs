...
/// </summary>
public class EmotionalSupportModule : SmartDevice
{
    ...
    /// </summary>
    public EmotionalSupportModule() : base("Модуль емоційної підтримки", 0.03)
    {
    ...
    /// </summary>
    public EmotionalSupportModule(string emotionalState, double stressLevel) : base("Модуль емоційної підтримки", 0.03)
    {
    ...
    /// </summary>
    public EmotionalSupportModule(EmotionalSupportModule other) : base(other.DeviceName, other.PowerConsumption)
    {
    ...
    {
        return $"Модуль '{DeviceName}' працює. Емоційний стан: {_emotionalState}, рівень стресу: {_stressLevel:F1}%. Енергоспоживання: {PowerConsumption} кВт.";
    }
}
