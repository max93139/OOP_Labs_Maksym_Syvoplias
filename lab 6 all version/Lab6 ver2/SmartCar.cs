...
/// Він успадковує абстрактний пристрій SmartDevice та реалізує інтерфейс ISmartVehicle (Inheritance & Interfaces).
/// </summary>
public class SmartCar : SmartDevice, ISmartVehicle
{
