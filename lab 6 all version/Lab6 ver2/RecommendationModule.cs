...
/// </summary>
public class RecommendationModule : SmartDevice
{
    ...
    /// </summary>
    public RecommendationModule() : base("Модуль рекомендацій", 0.02)
    {
    ...
    /// </summary>
    public RecommendationModule(string recommendationType, string userProfile) : base("Модуль рекомендацій", 0.02)
    {
    ...
    /// </summary>
    public RecommendationModule(RecommendationModule other) : base(other.DeviceName, other.PowerConsumption)
    {
    ...
    {
        return $"Модуль '{DeviceName}' працює. Профіль користувача: {_userProfile}, тип рекомендацій: {_recommendationType}. Енергоспоживання: {PowerConsumption} кВт.";
    }
}
