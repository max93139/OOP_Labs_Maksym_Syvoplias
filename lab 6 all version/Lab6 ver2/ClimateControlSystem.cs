...
/// </summary>
public sealed class ClimateControlSystem : SmartDevice
{
    ...
    /// </summary>
    public ClimateControlSystem(IReadOnlyList<ISensor> sensors) : base("Система клімат-контролю", 0.35)
    {
    ...
    /// <summary>
    /// Повертає статус системи клімат-контролю.
    /// </summary>
    public override string GetStatus()
    {
        return $"Модуль '{DeviceName}' підтримує баланс середовища. Енергоспоживання: {PowerConsumption} кВт.";
    }
}
