...
namespace Lab4
{
    ...
    class Program
    {
        ...
        /// Department і Student зберігаються через посилання на IEducationalEntity —
        /// демонстрація трирівневої ієрархії (інтерфейс → EducationalEntity → похідні класи).
        /// </summary>
        static void Main()
        {
            ...
            // Доступ до Department через посилання на інтерфейс IEducationalEntity —
            // демонстрація трирівневої ієрархії згідно з вимогою завдання.
            IEducationalEntity entity     = new Department();
