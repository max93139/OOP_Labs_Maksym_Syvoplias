...
{
    /// <summary>
    /// Базовий клас «Освітній суб'єкт» — уніфікує спільні атрибути
    /// та операції для всіх учасників освітнього процесу.
    /// Конструктор protected: унеможливлює пряме створення об'єкта,
    /// оскільки клас не є конкретним учасником предметної галузі.
    /// </summary>
